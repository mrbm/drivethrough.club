...
import com.google.android.gms.common.api.GoogleApiClient; //Ben //import com.google.android.gms.location.LocationClient;
import com.google.android.gms.location.LocationServices; //Ben  //import com.google.android.gms.common.GooglePlayServicesClient;
...
public class MainActivity extends FragmentActivity implements LocationListener,
        GoogleApiClient.ConnectionCallbacks, //Ben //GooglePlayServicesClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener //Ben //GooglePlayServicesClient.OnConnectionFailedListener,
{
    ...
    private GoogleApiClient locationClient;   //Ben //private LocationClient locationClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Ben //locationClient = new LocationClient(this, this, this);
        locationClient = new GoogleApiClient.Builder(this) //Ben
                .addApi(LocationServices.API) //Ben
                .addConnectionCallbacks(this) //Ben
                .addOnConnectionFailedListener(this) //Ben
                .build(); //Ben
    ...
    @Override //Ben
    public void onConnectionSuspended(int i) { //Ben
        Log.i(Application.APPTAG, "GoogleApiClient connection has been suspend"); //Ben
    } //Ben
    /*
    ...
    private void startPeriodicUpdates() {
        //Ben //locationClient.requestLocationUpdates(locationRequest, this);
        LocationServices.FusedLocationApi.requestLocationUpdates( //Ben
                locationClient, locationRequest, this); //Ben
    }
    ...
    private void stopPeriodicUpdates() {
        ...
        locationClient.disconnect();//Ben //locationClient.removeLocationUpdates(this);
    }
    ...
    private Location getLocation() {
        ...
        if (servicesConnected()) {
            // Get the current location
            return  LocationServices.FusedLocationApi.getLastLocation(locationClient); //Ben //return locationClient.getLastLocation();
        } else {
            return null;
        }
    }
